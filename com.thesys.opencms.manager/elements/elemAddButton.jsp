...
[<a href="#form_${param.rowId}" ref="${param.editUrl}" class="btnEdit">編輯</a>]
[<a href="#form_${param.rowId}" ref="<cms:link>/system/modules/com.thesys.opencms.manager/jsps/elemDelete.jsp</cms:link>" class="btnDelete">刪除</a>] 
